        ...
        <div className="container-fluid">
          <section className="text-gray-500 bg-gray-900 body-font">
            <div className="container px-5 py-4 mx-auto">
              ...
              <div className="flex flex-wrap -m-12 mb-3">
                ...
                <div className="p-2 lg:w-1/3 md:w-1/3 sm:w-full w-full">
                  <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
                    <div className="h-full flex-grow -m-4">
                      <h5 className="text-white title-font font-medium">
                        Yash Sharma
                      </h5>
                      <hr />
                      <p className="text-gray-500 ">Syash958@gmail.com</p>
                ...
                <div className="p-2 lg:w-1/3 md:w-1/3 w-full">
                  <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
                    <div className="flex-grow -m-4">
                      ...
                      <hr />
                      <p className="text-gray-500">Subhrathore2000@gmail.com</p>
