          ...
          <div className="container px-5 py-16 mx-auto">
            ...
            <div className="p-4 md:w-full sm:mb-0 mb-3">
              ...
              <p className="text-base leading-relaxed mt-2">
                We as a part of India's Biggest Hackthon feel very proud and
              ...
              <p className="text-white mt-2">
                Our Idea was to make PAPERLESS OFFICE APPLICATION which can make
            ...
            <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
              ...
              <div className="p-4 md:w-1/2 sm:mb-0 mb-4">
                ...
                <p className="text-base leading-relaxed mt-2">
                  ...
                  The local newspaper Dainik Bhaskar wrote our success story and
                  our App description
                  <span style={{ color: "teal", fontWeight: "bold" }}>
                    📰 PAPERLESS OFFICE
                  </span>
